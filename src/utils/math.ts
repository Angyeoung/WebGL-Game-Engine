...
export class Matrix4 {
     ...
     */
    static lookAt(eye: Vector3, target: Vector3, up: Vector3 = Vector3.up, dst?: Float32Array): Float32Array {
    ...
    static perspectiveFovLH(fov: number, aspect: number, near: number, far: number, dst?: Float32Array): Float32Array {
        dst = dst || Matrix4.identity();
    ...
    static rotateX(m: Float32Array, angle: number): Float32Array {
        ...
        const s = Math.sin(r);
        const c = Math.cos(r);
        return Matrix4.multiply(m, new Float32Array([
            1,  0, 0, 0,
            0,  c, s, 0,
            0, -s, c, 0,
            0,  0, 0, 1
    ...
    static invert(m: Float32Array, dst?: Float32Array) {
        ...
        dst[0] = l23 * l27; m[4] = l24 * l27; 
        dst[8] = l25 * l27; m[12] = l26 * l27;
